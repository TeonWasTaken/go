...
- [ ] 1. Update design tokens and color palette in `src/index.css`
  - [ ] 1.1 Add new shared design tokens to `:root`
  ...
  - [ ] 1.2 Update light theme tokens in `[data-theme="light"]`
  ...
  - [ ] 1.3 Update dark theme tokens in `[data-theme="dark"]`
...
- [ ] 2. Implement glass surface treatments and utility classes
  - [ ] 2.1 Add `glass--subtle` CSS class
  ...
  - [ ] 2.2 Add glass hover interactivity
    - Add `.glass:hover` rule with slight brightness increase via `filter: brightness(1.05)` or increased background opacity
    - _Requirements: 2.4_

- [ ] 3. Update typography and Neo-Brutalism accents
  - [ ] 3.1 Update app header title styling
  ...
  - [ ] 3.2 Update heading typography across components
...
- [ ] 4. Update button and interactive element styling
  ...
  - [ ] 4.2 Add tactile hover/press transforms to `.btn--primary`
...
- [ ] 7. Update modal and form styling
  - [ ] 7.1 Update modal overlay and glass treatment
...
- [ ] 8. Create ScopeToggle component and integrate into CreateEditModal
  - [ ] 8.1 Create `src/components/ScopeToggle.tsx`
  ...
  - [ ] 8.2 Add ScopeToggle CSS styles to `src/index.css`
  ...
  - [ ] 8.3 Replace checkbox with ScopeToggle in `src/components/CreateEditModal.tsx`
...
- [ ] 9. Update remaining component styles
  - [ ] 9.1 Update filter tabs styling
  ...
  - [ ] 9.3 Update toast notification styling
  ...
  - [ ] 9.4 Update popular links section styling
  ...
  - [ ] 9.5 Update theme toggle styling
  ...
  - [ ] 9.6 Update skeleton loader styling
    - Ensure `.skeleton` uses glass-tinted base color
    - Verify pulse animation exists and `prefers-reduced-motion` disables it
    - _Requirements: 12.1, 12.2_

- [ ] 10. Checkpoint — Verify all visual changes and component integration
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 11. Set up testing infrastructure
  - [ ] 11.1 Install test dependencies and configure vitest for the frontend
