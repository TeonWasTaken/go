...
export function createDeleteLinkHandler(strategy: AuthStrategy) {
  return async function deleteLinkHandler(
    req: HttpRequest,
...
export function registerDeleteLink(strategy: AuthStrategy): void {
  app.http("deleteLink", {
    methods: ["DELETE"],
    authLevel: "anonymous",
